...
namespace Tanks.Complete
{
    ...
    public class TankMovement : MonoBehaviour
    {
        ...
        private void Start ()
        {
            ...
            if (m_InputUser.InputUser.controlScheme.Value.name == "Gamepad" &&  ControlIndex == 1)
            {
                m_MoveAction = InputSystem.actions.FindAction("Vertical").Clone();
                m_TurnAction = InputSystem.actions.FindAction("Horizontal").Clone(); ;
            }
        ...
        private void Move ()
        {
            ...
            if (m_InputUser.InputUser.controlScheme.Value.name == "Gamepad" || m_IsDirectControl)
            {
                ...
                Debug.Log("MoveInPut " + speedInput);
            }
            else
            {
